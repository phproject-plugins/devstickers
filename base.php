...
class Base extends \Plugin {
	...
	public function _load() {
		$this->_hook("text.parse.after", function($str) {
			return preg_replace_callback("/:(404|btb|cannot-reproduce|codepush|compiling|facepalm|hack|helloworld|hotfix-denied|hotfix|idk|itrl|iwy|lgtm|loading|null|outofscope|plzwork|review|shipit|wfm|woot):/", function($matches) {
